    ...
    builder
      ...
      .addCase(getValuesThunk.fulfilled, (state, { payload }) => {
        const fields = {
          ...
          "telephone-mobile": getValueFromSlug(payload, "telephone-mobile"),
          "telephone-home": getValueFromSlug(payload, "telephone-home"),
          "e-mail": getValueFromSlug(payload, "e-mail"),
